...
// **Test code** from ../../misc/freetype/README.md
struct FreeTypeTest
{
    enum FontBuildMode
    {
...
int main(int, char**)
{
    ...
    if (!glfwInit())
        return 1;
    GLFWwindow* window = glfwCreateWindow(1280, 720, "Dear ImGui GLFW+OpenGL2+FreeType example", NULL, NULL);
    if (window == NULL)
        return 1;
    ...
    freetype_test.FontsFlags = ImGuiFreeType::NoHinting;
    io.Fonts->AddFontDefault();
    ImGuiFreeType::BuildFontAtlas(io.Fonts, freetype_test.FontsFlags);
